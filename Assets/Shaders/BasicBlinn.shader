Shader "Holistic/BasicBlinn"
{
    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            half4 LightingBasicBlinn (SurfaceOutput surface, half3 lightDir, half3 viewDir, half atten)
            {
                ...
                half4 color;
                color.rgb = (surface.Albedo * _LightColor0.rgb * diffuse + _LightColor0.rgb * spec) * atten;
